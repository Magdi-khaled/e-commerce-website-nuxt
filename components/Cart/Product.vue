...
<template>
    <div class="flex items-center sm:gap-4 gap-2">
        <div class="relative">
            ...
            <button class="absolute top-1 -right-10 cursor-pointer text-2xl text-hover hover:text-fade">
        ...
        <div class="grid gap-4 items-start mb-16">
            ...
            <div class="grid border-[2px] border-hover">
                ...
                <p class="border-y-[2px] border-y-hover py-px text-center" :class="{ 'font-semibold': !isCart }"> {{
                    selectedQuantity }}</p>
                <button
                    class="cursor-pointer py-[6px] flex items-center justify-center w-full h-full hover:bg-hover hover:text-neutral-50 transition-all">
