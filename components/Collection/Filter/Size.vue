...
const selectedSize = defineModel<string>('selectedSize');

const sizes = ['XS', 'S', 'M', 'L', 'XL', '2X'];
</script>

<template>
    <div class="border-b border-dashed py-4 border-b-hover">
        <h1 class="capitalize font-bold">size</h1>
        <div class="my-2 flex flex-wrap items-center gap-2">
            <p v-for="(item, index) in sizes" :key="index" @click="selectedSize = item"
